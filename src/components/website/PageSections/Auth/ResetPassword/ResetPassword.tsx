    ...
    <div className="min-h-screen flex items-center justify-center bg-[#ECF3EC] px-4 w-[500px]">
      ...
      >
        ...
        <motion.h2
          ...
          className="text-2xl sm:text-3xl font-semibold text-[#00C8B3] mb-2 text-center"
        >
        ...
        >
          ...
          <motion.div
            ...
            className="mb-5"
          >
            <label className="block text-[#00C8B3] font-medium mb-1">
              New Password
            </label>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full border border-[#E5E7EB] rounded-lg pl-10 pr-10 py-3 outline-none focus:border-[#00C8B3]"
                placeholder="********"
                value={newPassword}
          ...
          >
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full border border-gray-300 rounded-lg pl-10 pr-10 py-3 outline-none focus:border-[#00C8B3]"
                placeholder="********"
