  ...
  return (
    <div className="mx-auto container flex justify-center items-center min-h-screen">
      ...
      >
        ...
        >
          <div className="flex items-center justify-center w-12 h-12 bg-gradient-to-r from-[#005DAA] to-[#00C8B3] rounded-xl p-2">
        ...
        >
          ...
          >
            ...
            <Link
              ...
              className="text-sm text-[#00C8B3] hover:underline"
            >
              Forgot password?
            </Link>
          </motion.div>
          ...
          <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.97 }}>
            <Button
              className="w-full bg-gradient-to-r from-[#005DAA] to-[#00C8B3] mt-4 text-white cursor-pointer py-5 text-[16px]"
