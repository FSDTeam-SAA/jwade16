  ...
  return (
    <div className="flex justify-center items-center p-8 text-center">
      <div className="max-w-3xl bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
        {/* Heading */}
        <h1 className="text-3xl font-bold text-[#005DAA] mb-4">
          Admin Panel All Information
        </h1>

        {/* Subheading */}
        <h2 className="text-xl font-semibold text-[#005DAA] mb-3">
          Welcome Back!
        </h2>
        ...
        {/* Status Badge */}
        <div className="mt-5 inline-flex items-center rounded-lg bg-[#ECF3EC] px-4 py-2 text-sm font-semibold text-[#005DAA]">
          🚧 Work in Progress
        </div>
      </div>
    </div>
